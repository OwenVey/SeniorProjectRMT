...
const ProjectDashboard = () => (
  ...
  <div style={{ display: 'flex', height: '100vh', alignItems: 'center', justifyContent: 'center', backgroundColor: '#EEF'}}>
    <div style={{ width: 800 }}>
      ...
      <Icon name='file alternate outline'> Document View </Icon>
      <div></div>
      
      <Icon name='table'> Expanded View </Icon>
